...
int classificaForma(Dim fig)
{
    ...
    printf("\nf%u h%u v%u d%u di%u pp%u ap%u media%.3lf aret%.3lf pret%.3lf acir%.3lf pcir%.3lf", fig.rotulo, fig.horizontal, fig.vertical, fig.diagonal_bar, fig.diagonal_inv, fig.perimetro_pix, fig.area_pix, media_todos, area_ret, perimetro_ret, area_circ, perimetro_circ);
//TESTE
